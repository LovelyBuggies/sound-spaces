...
_TC.TASK.CATEGORY.ENCODING = "one_hot"
_TC.TASK.CATEGORY.PROMPT_TEMPLATE = "target object: {category_name}"
_TC.TASK.CATEGORY.MOCK_TEXT_EMBEDDING_DIM = 32
_TC.TASK.CATEGORY.MOCK_TEXT_SEED = 0
_TC.TASK.CATEGORY.MINILM_MODEL_NAME = "sentence-transformers/all-MiniLM-L6-v2"
_TC.TASK.CATEGORY.SIMILARITY_TEMPERATURE = 1.0
...
def get_config(
    ...
    config.WB_LOG_DIR = os.path.join(config.MODEL_DIR, 'tb')
